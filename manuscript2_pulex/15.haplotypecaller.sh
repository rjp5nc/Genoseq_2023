...
# OUT="/scratch/rjp5nc/rawdata/dpulex_all_ids.txt"

# cat \
#   /scratch/rjp5nc/rawdata/sra_metadata_out/sra_ids_dpulex.txt \
#   /scratch/rjp5nc/rawdata/mysamps_ids_dpulex_europe.txt \
# | sed 's/\r//g' \
# | awk 'NF{print $1}' \
# | sort -u \
# > "$OUT"
...
IDFILE="/scratch/rjp5nc/rawdata/dpulex_all_ids.txt"

# input BAMs from your previous pipeline
BAMDIR="/scratch/rjp5nc/UK2022_2024/redone_mito/eupulex/sortedbamsdedup_pulex"
...
# output gvcfs
OUTROOT="/scratch/rjp5nc/UK2022_2024/redone_mito/eupulex/gvcf_pulex"
mkdir -p "$OUTROOT"
