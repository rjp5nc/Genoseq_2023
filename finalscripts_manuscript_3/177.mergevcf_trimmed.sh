...
WORKING_FOLDER=/scratch/rjp5nc/UK2022_2024/daphnia_phylo/eudobtusa_indv/eudobtusa_gvcf_10bp
...
# Combined VCF name
output="/scratch/rjp5nc/UK2022_2024/daphnia_phylo/eudobtusa_indv/trimmed10bp_allsites_${species}.vcf.gz"
