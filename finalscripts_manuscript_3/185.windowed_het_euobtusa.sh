...
#SBATCH -t 0-10:00:00 ### 15 seconds
#SBATCH --mem 60G
...
VCF="/scratch/rjp5nc/UK2022_2024/daphnia_phylo/eudobtusa_indv/trimmed10bp_masked_euobtusa.vcf.gz"
WINDOW=100000          # 10 kb windows
RESULTDIR="/scratch/rjp5nc/UK2022_2024/daphnia_phylo/eudobtusa_indv/windowedhet"
mkdir -p "$RESULTDIR"
