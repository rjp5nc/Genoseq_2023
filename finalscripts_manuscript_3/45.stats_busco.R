...
ggsave("/scratch/rjp5nc/UK2022_2024/buscoanalysis/busco_missrates_variant.png", plot = miss_rates_all_short_plot, width = 6, height = 4, dpi = 300)
...
ggsave("/scratch/rjp5nc/UK2022_2024/buscoanalysis/missrates_samps.png", plot = miss_rates_samps_short_plot, width = 6, height = 4, dpi = 300)
...
write.csv(sampleStats, "/scratch/rjp5nc/UK2022_2024/buscoanalysis/sampleStats_busco.csv", row.names = FALSE)
