...
OUT_DIR=/scratch/rjp5nc/UK2022_2024/daphnia_phylo/usdobtusa_indv/pixy_allusobtusa
mkdir -p $OUT_DIR

pixy --stats pi \
    --vcf $VCF \
    --populations /scratch/rjp5nc/UK2022_2024/daphnia_phylo/pops_fixed.txt \
    --window_size 10000 \
    --n_cores 20 \
