...
RESULTDIR=dp_results_100k_unfiltered_eu
mkdir -p "$RESULTDIR"
...
# cat *avgdepth.long.sorted_100000.txt > ../avgdepth_all_unfilt_100k.txt
...
#     }
# }
# ' avgdepth_all_unfilt_100k.txt > window_avg_avgdepth_all_unfilt_100k.txt