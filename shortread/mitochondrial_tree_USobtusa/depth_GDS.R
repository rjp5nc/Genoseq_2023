...
ggsave("/scratch/rjp5nc/UK2022_2024/mito_vcf/mito_missrates_variant.png", plot = miss_rates_all_short_plot, width = 6, height = 4, dpi = 300)
...
ggsave("/scratch/rjp5nc/UK2022_2024/mito_vcf/mito_misssamps.png", plot = miss_rates_samps_short_plot, width = 6, height = 4, dpi = 300)
...
write.csv(sampleStats, "/scratch/rjp5nc/UK2022_2024/mito_vcf/mito_sampleStats.csv", row.names = FALSE)
