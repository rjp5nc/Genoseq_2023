...
gds.fn <- "/scratch/rjp5nc/UK2022_2024/mito_vcf/mito_lifted_all_missingasref.gds"
...
write.csv(dist_matrix, "/scratch/rjp5nc/UK2022_2024/mito_vcf/fullmito_similarity_matrix.csv")  # Save as CSV
...
png("/scratch/rjp5nc/UK2022_2024/mito_vcf/treemitophylogram_rectangular_all_rooted_by_P759.png", res = 300, width = 6000, height = 15000)
...
png("/scratch/rjp5nc/UK2022_2024/mito_vcf/treemitophylogram_fan_all_rooted_by_P759.png", res = 300, width = 9000, height = 9000)
#png("/scratch/rjp5nc/UK2022_2024/mito_vcf/tree_usobtusa_circ.png", width = 1200, height = 2000)
...
pdf("/scratch/rjp5nc/UK2022_2024/mito_vcf/heatmapusobtusagilmer.pdf", width=30, height=30)
...
png("/scratch/rjp5nc/UK2022_2024/mito_vcf/treemitophylogram_rectangular_upgma_all_rooted_by_P759.png", res = 300, width = 6000, height = 15000)
#png("/scratch/rjp5nc/UK2022_2024/mito_vcf/tree_usobtusa_circ.png", width = 1200, height = 2000)
