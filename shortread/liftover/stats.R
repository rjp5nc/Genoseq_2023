...
ggsave("/scratch/rjp5nc/UK2022_2024/daphnia_phylo/missrates_variant_ambigua_raw_beforeeverythign.png", plot = miss_rates_all_short_plot, width = 6, height = 4, dpi = 300)
