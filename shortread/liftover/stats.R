...
Species <- subset(samples, Species == "Daphnia obtusa" & Continent =="NorthAmerica")
...
ggsave("/scratch/rjp5nc/UK2022_2024/daphnia_phylo/missrates_variant_USobtusa.png", plot = miss_rates_all_short_plot, width = 6, height = 4, dpi = 300)
...
ggsave("/scratch/rjp5nc/UK2022_2024/daphnia_phylo/missrates_variant_USobtusa_samps.png", plot = miss_rates_samps_short_plot, width = 6, height = 4, dpi = 300)
...
write.csv(sampleStats, "/scratch/rjp5nc/UK2022_2024/daphnia_phylo/sampleStats_US_obtusa.csv", row.names = FALSE)
