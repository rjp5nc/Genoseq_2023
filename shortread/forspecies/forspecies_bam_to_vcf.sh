...
bam_list=$(ls /scratch/rjp5nc/UK2022_2024/allshortreads/mitosortedbams/*.sorted.bam | sort)

# Generate VCF with VarScan
samtools mpileup \
    --fasta-ref /scratch/rjp5nc/UK2022_2024/allshortreads/allcoi_updated22.fa \
    $bam_list | \
...
java -jar $EBROOTVARSCAN/VarScan.v2.4.4.jar mpileup2snp \
    ...
    --min-coverage 4 \
    --min-var-freq 0.001 \
    --output-vcf > /scratch/rjp5nc/UK2022_2024/allshortreads/mitoVCF.vcf
...
bcftools reheader \
    ...
    /scratch/rjp5nc/UK2022_2024/allshortreads/mitoVCF.vcf > \
    /scratch/rjp5nc/UK2022_2024/allshortreads/mitoVCF_renamed.vcf
