...
mitotypes_file <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/locset_n38__beavercreek-birdhut-cafe__etc/eudobtusa_mito_types.csv"

mcc_file     <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out/snapp5/snapp.mito.highest1.tree"
out_png_fan  <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/euobtusa_mito_tree_beastcirc.png"
out_pdf_fan  <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/euobtusa_mito_tree_beastcirc.pdf"
outgroup_tip <- "RobertUK_H6_clone"
...
## Save
## ------------------------
ggsave(out_png_fan, plot = p, width = 20, height = 14, dpi = 300)
