...
LOCATIONS <- c("Dcat", "D8", "Sharp")  # e.g. c("Dcat","dbUnk","FS")



LOCATIONS <- c("Dcat", "D8", "DBunk",
...
write.tree(tree_rooted2, file = file.path(out_dir, "eudpulex_tree_nwk.nwk"))
...
pdf(file.path(out_dir, "eudpulex_groups_circ_CLONELABELS.pdf"), width = 30, height = 16)
plot.phylo(
  tree_rooted2,
  type = "fan",
  cex = 0.7,
...
png(file.path(out_dir, "eudpulex_groups_circ_CLONELABELS.png"), width = 7000, height = 4000, res = 300)
plot.phylo(
  tree_rooted2,
  type = "fan",
  cex = 0.7,
