...
diffs <- read.csv("/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_types_diff_df.csv")
...
mitotype_csv <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_types.csv"
...
gds.fn <- "/scratch/rjp5nc/UK2022_2024/redone_mito/euobtusa/cohort_gendb/obtusa.mito.ALLSITES.rmMissGT0.3.gds"
...
# Write file
out_path <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/sample_mean_depth.csv"
...
groups <- read_csv("/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_types.csv") %>%
...
write_csv(top_per_group,
          "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_top_sample_per_group_by_DP.csv")

# also write just the samples for bash
writeLines(top_per_group$sample,
           "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_top_samples.txt")




samples_to_keep <- usobtusasamps %>% filter(Species == "Daphnia obtusa" & Continent == "Europe") %>% pull(Sample_ID)
...
sra_map <- subset(sra_map, ScientificName == "Daphnia obtusa")
...
srasampsloc <- subset(srasampsloc, location != "Pond2")
srasampsloc <- subset(srasampsloc, location != "Pond20")
...
keep_samples <- unique(c(keep_samples, "SRR14476620"))


writeLines(final_valid_samples, "/scratch/rjp5nc/rawdata/sra_metadata_out/final_valid_samples_obtusa.txt")
...
## 7) Save + quick plot
out_dir <- "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_unique_snps_by_group"
...
#write.csv(diff_df,"/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_types_diff_df.csv")
...
png("/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_grouping_graph_mito.png",
...
# 11) Plot tree
# ------------------------------------------------------------
png("/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_groups.png",
...
png("/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_groups_circ.png",
...
pdf(
  "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_groups_circ.pdf",
  width = 20,
  height = 15)
...
tree_rooted <- root(tree, outgroup = "SRR14476620", resolve.root = TRUE)
tree_id <- tree_rooted
...
ggsave(
  "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_groups_dots_circ.png",
  p_circ, width = 12, height = 12, dpi = 300
)

ggsave(
  "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_groups_dots_circ.pdf",
  p_circ, width = 12, height = 12, dpi = 300
)
...
ggsave(
  "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_groups_dots_rect.png",
  p_rect,
  width = 12,
  height = 12,
  dpi = 300
...
write.tree(tree_rooted2,
           file = "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_tree_nwk.nwk")

fwrite(unique_clones,
       "/scratch/rjp5nc/UK2022_2024/mitogvcf/gvcf/eudobtusa_mito_reverse_out_all/eudobtusa_mito_types.csv")
...
write.csv(pca_data, file.path(out_dir, "euobtusa_mito_pca.csv"),
...
write.csv(pca_merged,
          file.path(out_dir, "euobtusa_mito_pca_with_mitotype.csv"),
          row.names = FALSE, quote = FALSE)
...
ggsave(file.path(out_dir, "euobtusa_pca_mito_PC1_PC2_noNA.png"),
